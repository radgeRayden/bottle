...
fn ()
    ...
    plonk.line line-vertices 15:f32 (vec4 1 0.5 0.7 1) LineJoinKind.Bevel LineCapKind.Round
    plonk.line line-vertices 7:f32 (vec4 0 0.5 0.7 1) LineJoinKind.Bevel LineCapKind.Round
    plonk.polygon (vec2 450 200) 5 100 rotation

    plonk.line line-vertices2 35:f32 (vec4 1 0.5 0.7 1) LineJoinKind.Round LineCapKind.Square
    plonk.line line-vertices2 30:f32 (vec4 0 0.5 0.7 1) LineJoinKind.Round LineCapKind.Square
